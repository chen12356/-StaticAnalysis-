...
def get_dex_files(app_dir):
    ...
    print(glob_pattern)
    logger.info("glob_pattern:{0}".format(glob_pattern))
...
def dex_2_smali(app_dir, tools_dir):
    ...
    try:
        ...
        print(dexes)
        # dexes = ['/home/ccq/xxxx.dex'] #测试
        logger.info("dexes:{0}".format(dexes))
...
if __name__ == '__main__':
    ...
    tools_dir = "/home/ccq/Projects/mobile-security-framework-mobsf/StaticAnalyzer/tools/"
    output_dir = '/home/ccq/T/'
    dex_2_smali(output_dir,tools_dir)